...
import CustomerMenu from "../menu/CustometMenu";
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`z-50 md:fixed flex flex-col justify-between overflow-x-hidden bg-gray-100 w-64 space-y-6 py-4 absolute inset-y-0 left-0 transform ${
          ...
          <div className="flex flex-col justify-between flex-1 mt-6">
            ...
            <nav>
              ...
              <MenuItem
                ...
                icon={BsGraphUp}
              />
              {user?.role === userRole.Customer && <CustomerMenu />}
              {user?.role === userRole.Agent && <AgentMenu />}
